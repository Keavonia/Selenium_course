...
try:
    ...
    input3.send_keys("rina.@gmail.com")

    div = browser.find_element(By.XPATH, "//div[@class='second_block']")
    input4 = div.find_element(By.CLASS_NAME, "first")
    input4.send_keys("89900898909")

    input5 = div.find_element(By.CLASS_NAME, "second")
    input5.send_keys("Smolensk, dfgfg fhgfgyt 34")
